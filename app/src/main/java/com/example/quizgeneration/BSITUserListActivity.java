...
public class BSITUserListActivity extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bsituser_list);
    ...
    private void navigateToUserList(String section) {
        ...
        intent.putExtra("registrationYear", getIntent().getStringExtra("registrationYear"));// Pass the selected course
